...
CLASSES = [
    ...
    "axolotl", "bullfrog", "tree frog", "tailed frog", "loggerhead sea turtle", 
    ...
    "green lizard", "African chameleon", "Komodo dragon", "Nile crocodile", 
    "American alligator", "triceratops", "thunder snake", "ring-necked snake", 
    "eastern hog-nosed snake", "smooth green snake", "king snake", 
    ...
    "Chihuahua", "Japanese spaniel", "Maltese dog", "Pekingese", 
    ...
    "Walker foxhound", "English foxhound", "redbone coonhound", "borzoi", 
    ...
    "Saint Bernard", "husky", "Alaskan malamute", "Siberian husky", 
    "Dalmatian", "affenpinscher", "basenji", "pug", "Leonberger", 
    "Newfoundland", "Great Pyrenees", "Samoyed", "Pomeranian", "chow chow", 
    "keeshond", "Brabancon griffon", "Pembroke Welsh corgi", 
    ...
    "admiral", "ringlet", "monarch butterfly", "cabbage butterfly", 
    "sulphur butterfly", "lycaenid", "starfish", "sea urchin", 
    "sea cucumber", "wood rabbit", "hare", "Angora rabbit", "hamster", 
    "porcupine", "fox squirrel", "marmot", "beaver", "guinea pig", "sorrel", 
    "zebra", "hog", "wild boar", "warthog", "hippopotamus", "ox", 
    "water buffalo", "bison", "ram", "bighorn sheep", "ibex", 
    ...
    "gibbon", "siamang", "guenon", "patas monkey", "baboon", "macaque", 
    "langur", "colobus monkey", "proboscis monkey", "marmoset", 
    "capuchin monkey", "howler monkey", "titi monkey", "spider monkey", 
    "squirrel monkey", "Madagascar cat", "indri", "Indian elephant", 
    "African elephant", "lesser panda", "giant panda", "barracouta", "eel", 
    "coho salmon", "rock beauty", "anemone fish", "sturgeon", "garfish", 
    ...
    "bassoon", "bathing cap", "bath towel", "bathtub", "beach wagon", 
    "beacon", "beaker", "bearskin", "beer bottle", "beer glass", 
    "bell cote", "bib", "bicycle-built-for-two", "bikini", "binder", 
    "binoculars", "birdhouse", "boathouse", "bobsled", "bolo tie", 
    "bonnet", "bookcase", "bookshop", "bottleneck guard", "bottlecap", 
    "bow", "bow tie", "brass", "brassiere", "breakwater", "breastplate", 
    "broom", "bucket", "buckle", "bulletproof vest", "bullet train", 
    "butcher shop", "cab", "caldron", "candle", "cannon", "canoe", 
    "can opener", "cardigan", "car mirror", "carousel", "carpenter's kit", 
    "carton", "car wheel", "cash machine", "cassette", "cassette player", 
    "castle", "catamaran", "CD player", "cello", "cellular telephone", 
    "chain", "chain-link fence", "chain mail", "chain saw", "chest", 
    "chiffonier", "chime", "china cabinet", "Christmas stocking", "church", 
    "cinema", "cleaver", "cliff dwelling", "cloak", "clog", "cocktail shaker", 
    "coffee mug", "coffeepot", "coil", "combination lock", "computer keyboard", 
    "confectionery", "container ship", "convertible", "corkscrew", 
    "cornet", "cowboy boot", "cowboy hat", "cradle", "crane (machine)", 
    "crash helmet", "crate", "crib", "crock pot", "croquet ball", "crutch", 
    ...
    "garbage truck", "gasmask", "gas pump", "goblet", "go-kart", "golf ball", 
    "golfcart", "gondola", "gong", "gown", "grand piano", "greenhouse", 
    ...
    "hatchet", "holster", "home theater", "honeycomb", "hook", "hoopskirt", 
    "horizontal bar", "horse-drawn cart", "hourglass", "iPod", 
    "iron", "jack-o'-lantern", "jeans", "jeep", "jersey", "jigsaw puzzle", 
    "jinrikisha", "joystick", "kimono", "knee pad", "knot", "lab coat", 
    "ladle", "lampshade", "laptop computer", "lawn mower", "lens cap", 
    "letter opener", "library", "lifeboat", "lighter", "limousine", 
    ...
    "pick", "pickelhaube", "picket fence", "pickup truck", "pier", "piggy bank", 
    "pill bottle", "pillow", "pinball machine", "pinwheel", "pirate ship", 
    "pitcher", "plane", "planetarium", "plastic bag", "plate rack", "plow", 
    "plunger", "Polaroid camera", "pole", "police van", "poncho", "pool table", 
    "pop bottle", "postbox", "pot", "potter's wheel", "power drill", 
    "prayer rug", "printer", "prison", "projectile", "projector", "punching bag", 
    "purse", "quill pen", "quilt", "race car", "racket", "radiator", "radio", 
    ...
    "sandal", "sarong", "saxophone", "scabbard", "scale", "school bus", 
    ...
    "sports car", "spotlight", "stage", "steam locomotive", "steel arch bridge", 
    "steel drum", "stethoscope", "stocking", "stone wall", "stopwatch", 
